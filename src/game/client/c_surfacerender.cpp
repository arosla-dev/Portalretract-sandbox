...
// Normal: 3.3
// "Portal 2": 5.5
ConVar r_surface_blr_cutoff_radius( "r_surface_blr_cutoff_radius", "4.25", FCVAR_NONE, "Set cutoff radius (how far field extends from each particle)" );
...
void Surface_DrawIsoSurface( IClientRenderable *pClientRenderable, const Vector &vecRenderOrigin, IMaterial *pMaterial, float flCubeWidth )
{
	...
	if( !IsErrorMaterial( pSpecialMaterial ) )
	{
