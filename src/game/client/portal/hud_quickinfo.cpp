...
ConVar	hud_quickinfo_beta("hud_quickinfo_beta", "0", FCVAR_ARCHIVE);
...
void CHUDQuickInfo::VidInit( void )
{
	...
	if ( IsX360() )
	{
		m_icon_rb_portal = HudIcons().GetIcon( "portal_crosshair_right_valid_x360" );
		m_icon_lb_portal = HudIcons().GetIcon("portal_crosshair_left_valid_x360");
		m_icon_rbe_portal = HudIcons().GetIcon("portal_crosshair_last_placed_x360");
		m_icon_lbe_portal = HudIcons().GetIcon("portal_crosshair_last_placed_x360");
		m_icon_rbn_portal = HudIcons().GetIcon("portal_crosshair_right_invalid_x360");
		m_icon_lbn_portal = HudIcons().GetIcon("portal_crosshair_left_invalid_x360");
	}
	else
	{
		m_icon_rb_portal = HudIcons().GetIcon("portal_crosshair_right_valid");
		m_icon_lb_portal = HudIcons().GetIcon("portal_crosshair_left_valid");
		m_icon_rbe_portal = HudIcons().GetIcon("portal_crosshair_last_placed");
		m_icon_lbe_portal = HudIcons().GetIcon("portal_crosshair_last_placed");
		m_icon_rbn_portal = HudIcons().GetIcon("portal_crosshair_right_invalid");
		m_icon_lbn_portal = HudIcons().GetIcon("portal_crosshair_left_invalid");
	}
}
...
void CHUDQuickInfo::Paint()
{
	...
	float fRightPlaceBarFill = 0.0f;
		...
		*/
		...
		GetHud().DrawIconProgressBar(xCenter - (m_icon_lb->Width() * 2), yCenter, m_icon_lb, m_icon_lbe, (1.0f - m_fCBlend1), portal1Color, CHud::HUDPB_VERTICAL);
		GetHud().DrawIconProgressBar(xCenter + m_icon_rb->Width(), yCenter, m_icon_rb, m_icon_rbe, (1.0f - m_fCBlend2), portal2Color, CHud::HUDPB_VERTICAL);
