...
#ifdef PORTAL
	// HACK: Use m_clrRender->a
	// this is not an adequate fix, as the proper solution would be fixing instance.m_nAlpha
	// and AlphaProp()->m_nAlpha
	beamInfo.m_flBrightness = pbeam->GetRenderAlphaRaw();
#else
