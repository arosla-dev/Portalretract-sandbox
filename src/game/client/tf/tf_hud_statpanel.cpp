...
extern bool UTIL_GetMapLoadCountFileName( int iController, const char *pszFilePrependName, char *pszBuffer, int iBuflen );
...
void CTFStatPanel::WriteStats( void )
{
	...
	if ( IsX360() )
	{
		...
		if ( xboxsystem && UTIL_GetMapLoadCountFileName( iController, MAP_KEY_FILE, szFilename, _MAX_PATH ) )
