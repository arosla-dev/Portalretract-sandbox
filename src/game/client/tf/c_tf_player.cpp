...
void C_TFRagdoll::CreateTFRagdoll()
{
	...
	{
		ClientLeafSystem()->CreateRenderableHandle( this, false, RENDERABLE_IS_TRANSLUCENT, RENDERABLE_MODEL_ENTITY );
	}		
...
void C_TFPlayer::UpdateIDTarget()
{
	...
	VectorMA( MainViewOrigin( GET_ACTIVE_SPLITSCREEN_SLOT() ), MAX_TRACE_LENGTH, MainViewForward( GET_ACTIVE_SPLITSCREEN_SLOT() ), vecEnd );
...
bool C_TFPlayer::Simulate( void )
{
	...
	return BaseClass::BaseClass::Simulate();
}
...
// Old, deprecated function from earlier source versions
/*
...
*/
uint8 C_TFPlayer::OverrideShadowAlphaModulation( uint8 nAlpha )
{
	uint8 nNewAlpha = nAlpha;
