...
//=========================================================
#ifdef PORTAL
class CNPC_RollerMine : public PropPaintPowerUser< CNPCBaseInteractive<CAI_BaseNPC> >, public CDefaultPlayerPickupVPhysics
#else
class CNPC_RollerMine : public CNPCBaseInteractive<CAI_BaseNPC>, public CDefaultPlayerPickupVPhysics
#endif
{
#ifdef PORTAL
	DECLARE_CLASS( CNPC_RollerMine, PropPaintPowerUser< CNPCBaseInteractive<CAI_BaseNPC> > );
#else
