...
ConVar oicw_switch_mode_sounds("ar2_switch_mode_sounds", "1", FCVAR_ARCHIVE, "Switches OICW mode sounds");
...
void CWeaponAR2::ItemPostFrame(void)
{
	...
	*/
	...
	if (pOwner->m_afButtonPressed & IN_ALT1)
	{
		...
		if (oicw_switch_mode_sounds.GetBool())
		{
...
Activity CWeaponAR2::GetPrimaryAttackActivity(void)
{
	...
	if (m_nShotsFired < 3)
		return ACT_VM_HITLEFT; //ACT_VM_RECOIL1;

	if (m_nShotsFired < 4)
		return ACT_VM_HITLEFT2; //ACT_VM_RECOIL2;

	return ACT_VM_HITRIGHT; //ACT_VM_RECOIL3;
}
...
void CWeaponAR2::SecondaryAttack(void)
{
	...
	BaseClass::WeaponSound(DOUBLE_NPC);
