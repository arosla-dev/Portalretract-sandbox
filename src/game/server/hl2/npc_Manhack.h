...
//-----------------------------------------------------------------------------
#ifdef PORTAL
class CNPC_Manhack : public PropPaintPowerUser< CNPCBaseInteractive<CAI_BasePhysicsFlyingBot> >, public CDefaultPlayerPickupVPhysics
#else
class CNPC_Manhack : public CNPCBaseInteractive<CAI_BasePhysicsFlyingBot>, public CDefaultPlayerPickupVPhysics
#endif
{
#ifdef PORTAL
DECLARE_CLASS( CNPC_Manhack, PropPaintPowerUser< CNPCBaseInteractive<CAI_BasePhysicsFlyingBot> > );
#else
