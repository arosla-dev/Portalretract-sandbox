...
ConVar	flaregun_primary_velocity("sv_flaregun_primary_velocity", "1500", FCVAR_ARCHIVE);
ConVar	flaregun_secondary_velocity("sv_flaregun_secondary_velocity", "500", FCVAR_ARCHIVE);
ConVar	flaregun_duration_seconds("sv_flaregun_lifetime_seconds", "30", FCVAR_ARCHIVE);
ConVar	flaregun_stop_velocity("sv_flaregun_stop_velocity", "128", FCVAR_ARCHIVE);
ConVar	flaregun_projectile_sticky("sv_flaregun_projectile_sticky", "0", FCVAR_ARCHIVE);
ConVar	flaregun_dynamic_lights("sv_flaregun_dynamic_lights", "1", FCVAR_ARCHIVE);
