...
BrickbatAmmo_s	BrickBatAmmoArray[NUM_BRICKBAT_AMMO_TYPES] =
{
	...
	{ "grenade_headcrab",		BRICKBAT_HEADCRAB,		4,	"models/weapons/v_bb_headcrab.mdl",	"models/headcrab.mdl" },
	{ "grenade_crematorhead",	BRICKBAT_CREMATORHEAD,	6,	"models/weapons/v_bb_crematorhead.mdl",	"models/cremator_head.mdl" },
};
