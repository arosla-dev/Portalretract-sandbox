...
#include "new/weapons/weapon_brickbat.h"
#include "soundent.h"
#include "decals.h"
#include "IEffects.h"
...
{
public:
	DECLARE_CLASS( CGrenadeHeadcrab, CGrenade_Brickbat );
...
void CGrenadeHeadcrab::Detonate( void )
{	
	trace_t trace;
...
bool CGrenadeHeadcrab::CreateVPhysics()
{
	// Create the object in the physics system
	//VPhysicsInitNormal( SOLID_BBOX, FSOLID_NOT_STANDABLE, false );
	//IPhysicsObject *pPhysics = VPhysicsGetObject();

	//IPhysicsMotionController *m_pMotionController = physenv->CreateMotionController( (IMotionEvent *)this );
	//m_pMotionController->AttachObject( pPhysics, true );
