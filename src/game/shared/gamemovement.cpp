...
bool CGameMovement::CheckJumpButton( void )
{
	...
	if ( gpGlobals->maxClients == 1 )
	{
		...
		bool bInactiveSpeedPaint = pPortalPlayer->GetPaintPower( SPEED_POWER ).m_State == INACTIVE_PAINT_POWER;
		if ( bInactiveSpeedPaint || mv->m_vecVelocity.Length() <= 320 ) // HL2_SPRINT_SPEED
#endif
		{
