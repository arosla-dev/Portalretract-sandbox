...
#define SYRINGE_DISPATCH_EFFECT_STRING		"ClientProjectile_Syringe"
...
int g_sModelIndexSyringe;

PRECACHE_REGISTER_BEGIN( GLOBAL, PrecacheSyringe )
	PRECACHE_INDEX( MODEL, SYRINGE_MODEL, g_sModelIndexSyringe )
...
{
	return static_cast<CTFProjectile_Syringe*>( CTFBaseProjectile::Create( "tf_projectile_syringe", vecOrigin, vecAngles, pOwner, CTFProjectile_Syringe::GetInitialVelocity(), g_sModelIndexSyringe, SYRINGE_DISPATCH_EFFECT_STRING, pScorer, bCritical ) );
}
