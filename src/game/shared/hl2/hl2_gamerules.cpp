...
ConVar	sk_max_water			( "sk_max_water","0", FCVAR_REPLICATED);
ConVar	sk_max_fuel				( "sk_max_fuel","0", FCVAR_REPLICATED);
...
//		def.AddAmmoType("Extinguisher",		DMG_BURN,					TRACER_NONE,			0,	0, 100, 0, 0 );
		...
		def.AddAmmoType("Water",			DMG_GENERIC,				TRACER_NONE,			0,	0, "sk_max_water", 0, 0 );
		def.AddAmmoType("Fuel",				DMG_GENERIC,				TRACER_NONE,			0,	0, "sk_max_fuel", 0, 0 );
