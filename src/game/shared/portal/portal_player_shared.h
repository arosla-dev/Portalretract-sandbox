...
void ComputeAABBContactsWithBrushEntity( CPortal_Player *pPlayer, ContactVector& contacts, const Vector& boxOrigin, const Vector& boxMin, const Vector& boxMax, CBaseEntity* pBrushEntity, int contentsMask = CONTENTS_BRUSH_PAINT );
void ComputeAABBContactsWithBrushEntity( CPortal_Player *pPlayer, ContactVector& contacts, const cplane_t *pClipPlanes, int iClipPlaneCount, const Vector& boxOrigin, const Vector& boxMin, const Vector& boxMax, CBaseEntity* pBrushEntity, int contentsMask = CONTENTS_BRUSH_PAINT );
void ComputeAABBContactsWithNonWorldBrushEntity( CPortal_Player *pPlayer, ContactVector& contacts, CBaseEntity* pBrushEntity, int contentsMask = CONTENTS_BRUSH_PAINT );
