...
protected:
	void PaintBlobMoveThroughPortal(float flDeltaTime, CProp_Portal *pInPortal, const Vector &vecStartPos, const Vector &vecTransformedEndPos);
...
#ifdef PORTAL2 // In Retract, disable ghosted blobs (they don't get culled)
	// ghosting data
	bool m_bGhosting;
