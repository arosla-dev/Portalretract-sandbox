...
PaintPowerType UTIL_Paint_TracePower( CBaseEntity* pBrushEntity, const Vector& contactPoint, const Vector& vContactNormal, float *pflDetectionRadius = NULL );
Color UTIL_Paint_TraceColor( CBaseEntity* pBrushEntity, const Vector& contactPoint, const Vector& vContactNormal, float *pflDetectionRadius = NULL );
