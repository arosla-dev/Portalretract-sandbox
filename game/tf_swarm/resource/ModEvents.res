...
"ModEvents"
{
	...
	{
		"pyro_userid"	"short"		// userid of the pyro who ignited the victim
		"victim_userid"	"short"		// userid of the player ignited by the pyro
		"medic_userid"	"short"		// userid of the medic releasing the invuln
	}
	"player_ignited"			// sent when a player is ignited, only to the two players involved
	{
		"pyro_userid"	"short"		// userid of the pyro who ignited the victim
		"victim_userid"	"short"		// userid of the player ignited by the pyro
		"weaponid"		"short"		// weaponid of the weapon used
	}
